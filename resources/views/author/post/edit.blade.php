            ...
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="form-group">
                            <input type="checkbox" id="publish" class="filled-in chk-col-light-blue" name="status" value="1" {{ $post->status == true ? 'checked' : '' }}>
            ...
            <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <a href="{{route('author.post.index')}}" type="button" class="btn btn-danger m-t-15 waves-effect">KEMBALI</a>
